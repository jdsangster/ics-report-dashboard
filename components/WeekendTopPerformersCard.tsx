...
import { WeekendTopPerformer } from "@/lib/types";
import { formatNumber } from "@/lib/utils";

interface WeekendTopPerformersCardProps {
  performers: WeekendTopPerformer[];
}

const MEDALS: Record<number, string> = { 1: "🥇", 2: "🥈", 3: "🥉" };

export default function WeekendTopPerformersCard({ performers }: WeekendTopPerformersCardProps) {
  return (
    <motion.div
    ...
    >
      <div className="border-b border-border-subtle px-5 py-4">
        ...
        <p className="mt-0.5 text-xs text-muted">Highest IC production</p>
      </div>
