...
import { WeekendTeamRanking } from "@/lib/types";
import { formatNumber } from "@/lib/utils";

interface WeekendTeamRankingCardProps {
  ranking: WeekendTeamRanking[];
}

const MEDALS: Record<number, string> = { 1: "🥇", 2: "🥈", 3: "🥉", 4: "4️⃣" };

export default function WeekendTeamRankingCard({ ranking }: WeekendTeamRankingCardProps) {
  return (
    <motion.div
